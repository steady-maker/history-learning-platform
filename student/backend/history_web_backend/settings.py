"""
Django settings for history_web_backend project.
...
ROOT_URLCONF = 'history_web_backend.urls'
...
WSGI_APPLICATION = 'history_web_backend.wsgi.application'
...
LOGGING = {
    ...
    "handlers": {
        "default": {
            ...
            "filename": os.path.join(BASE_LOG_DIR, "history_web_info.log"),
        ...
        "warn": {
            "level": "WARNING",
            "class": "logging.handlers.TimedRotatingFileHandler",  # 保存到文件，根据时间自动切
            "filename": os.path.join(BASE_LOG_DIR, "history_web_warning.log"),
            "backupCount": 3,  # 备份数为3  xx.log --> xx.log.2018-08-23_00-00-00 --> xx.log.2018-08-24_00-00-00 --> ...
            "when": "D",  # 每天一切， 可选值有S/秒 M/分 H/小时 D/天 W0-W6/周(0=周一) midnight/如果没指定时间就默认在午夜
            "formatter": "standard",
            "encoding": "utf-8",
        ...
        "error": {
            "level": "ERROR",
            "class": "logging.handlers.TimedRotatingFileHandler",  # 保存到文件，根据时间自动切
            "filename": os.path.join(BASE_LOG_DIR, "history_web_err.log"),  # 日志文件
            "backupCount": 3,  # 备份数为3  xx.log --> xx.log.2018-08-23_00-00-00 --> xx.log.2018-08-24_00-00-00 --> ...
            "when": "D",  # 每天一切， 可选值有S/秒 M/分 H/小时 D/天 W0-W6/周(0=周一) midnight/如果没指定时间就默认在午夜
            "formatter": "standard",
            "encoding": "utf-8",
...
AI_CONFIG = {
    ...
    # "VOLC_ARK": {
    #     "API_KEY": os.getenv("ARK_API_KEY", ""),  # 你的火山方舟单密钥
    #     "BASE_URL": "https://ark.cn-beijing.volces.com/api/v3",  # 官方固定地址
    #     "MODEL": "doubao-seed-1-6-flash-250828"  # 官方样例中的模型名（需替换为你部署的模型名）
    # },
    "VOLC_ARK": {
