<template>
   <div class="app-container">
      ...
      >
         ...
         <el-table-column prop="visible" align="center" label="显示状态" width="80">
            <template #default="scope">
               <dict-tag :options="sys_show_hide" :value="scope.row.visible" />
            </template>
         </el-table-column>
         <el-table-column prop="status" align="center" label="菜单状态" width="80">
            <template #default="scope">
         ...
         <el-table-column label="操作" align="center" width="210" class-name="small-padding fixed-width">
            <template #default="scope">
               ...
               <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:menu:rm']">删除</el-button>
            </template>
         </el-table-column>
      </el-table>
...
const data = reactive({
  ...
  rules: {
    name: requiredAndTrim('菜单名称不能为空'),
    sort: [{ required: true, message: "菜单顺序不能为空", trigger: "blur" }],
    path: requiredAndTrim('路由地址不能为空')
  },
})
