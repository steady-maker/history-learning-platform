...
admin_table_prefix = "history_"  # 数据库表名前缀
web_table_prefix = "history_web_"
...
class CoreModel(models.Model):
    ...
    create_by = models.BigIntegerField(null=True,verbose_name='创建人ID',help_text="创建人ID")
    update_by = models.BigIntegerField(null=True,verbose_name='修改人ID',help_text="修改人ID")
    create_name = models.CharField(max_length=100, null=True, blank=True, help_text="创建人名称", verbose_name="创建人名称")
    update_name = models.CharField(max_length=100, null=True, blank=True, help_text="修改人名称", verbose_name="修改人名称")
